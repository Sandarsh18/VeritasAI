            ...
            {coinData.map((coin) => (
                <div key={coin.symbol} className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <img src={coin.iconUrl} alt={`${coin.name} icon`} className="h-8 w-8 rounded-full object-cover"/>
                        <div>
                    ...
                    <div className="text-right">
                        ...
                        <p className={cn("text-xs font-medium", coin.change >= 0 ? "text-green-500" : "text-red-500")}>

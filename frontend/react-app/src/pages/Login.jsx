    ...
    <div className="va-auth-page">
      <div className="va-auth-card">
        ...
        >
          ...
          <h1 className="va-auth-heading">Welcome Back</h1>
          <p className="va-auth-subtext">Enter your email and password to access your account.</p>
          ...
          <form className="va-auth-form" onSubmit={handleSubmit}>
            ...
            <motion.div className="va-field with-icon" variants={fieldVariants} initial="hidden" animate="visible" custom={1}>
              <label className="va-label" htmlFor="login-password">Password</label>
            ...
            <motion.div className="va-options-row" variants={fieldVariants} initial="hidden" animate="visible" custom={2}>
              <label className="va-check-wrap" htmlFor="remember-me">
                <input
                  id="remember-me"
                  type="checkbox"
                  className="va-check"
              ...
              <a className="va-forgot-link" href="#">Forgot Your Password?</a>
            </motion.div>
            ...
            <motion.div className="va-divider" variants={fieldVariants} initial="hidden" animate="visible" custom={4}>
              <span>Or Login With</span>
            </motion.div>

            <motion.div className="va-oauth-row" variants={fieldVariants} initial="hidden" animate="visible" custom={5}>
